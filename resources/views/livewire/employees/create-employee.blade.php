                            ...
                            <div class="row col-12 mb-3">
                                <div class="multiform">
                                    ...
                                    <div class="progress-bar">
                                        <div class="progress-bar-inner" style="width: {{ ($currentStep / 4) * 100 }}%;">
                                        </div>
                                    </div>
                                        ...
                                        <div class="row col-12">
                                            ...
                                            <div class="col-4">
                                                <label for="seniority_days" class="form-label">Dias de
                                                    antiguedad</label>
                                                <input type="number" class="form-control" id="seniority_days"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        @if ($currentStep === 4)
                                            <button type="submit" class="btn btn-success">Registrar
                                                Empleado <div class="spinner-border text-dark" wire:loading wire:target="save" role="status">
